...
>
  <script
    src='<%= ResolveClientUrl("Frm_Dist_Administracion.js?version20201012")%>'
  ></script>
              ...
              <ul class="Menu">
                <li class="BtnDistribuidor">
                  <ul class="SubMenu">
                    ...
                    <li>
                      <a
                        href='<%= ResolveClientUrl("~/Forms/Adm/Frm_Adm_Empleado.aspx")%>'
                        >(Alt + M) - Empleados</a
                      >
                    </li>
                    <%--
              ...
              <ul class="Menu">
                <li class="BtnDistribuidor">
                  <ul class="SubMenu">
                    <li>
                      <a
                        href='<%= ResolveClientUrl("~/Forms/Adm/Frm_Adm_ChequesTerceros.aspx")%>'
                        >(Alt + T) - Cheques de Terceros</a
                      >
                    </li>
                  </ul>
                </li>
