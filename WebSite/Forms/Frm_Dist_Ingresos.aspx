...
<asp:Content
    ...
    <script src='<%= ResolveClientUrl("Frm_Dist_Ingresos.js?version=20210718_")%>'></script>
    <script>
                        ...
                        <nav>
                            <ul class="Menu">
                                <li class="BtnDistribuidor">
                                    <ul class="SubMenu">
                                        <li>
                                            <a id="FORM3_BTNINGRESOS" style="display: none;"
                                                href='<%= ResolveClientUrl("~/Forms/ADM/Frm_Adm_Ingreso.aspx")%>'>(Alt + I) - Ingresos</a>
                                        </li>
                                        <li>
                                            <a id="FORM3_BTNINGRESOSMANUALES" style="display: none;"
                                                href='<%= ResolveClientUrl("~/Forms/ADM/Frm_Adm_IngresoManual.aspx")%>'>(Alt + M) - Ingresos Manuales</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
