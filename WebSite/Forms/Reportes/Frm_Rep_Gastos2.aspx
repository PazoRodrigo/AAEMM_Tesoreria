...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script src='<%= ResolveClientUrl("Frm_Rep_Gastos2.js?version20200602_1")%>'></script>
    <script>
                        ...
                        <div class="container border border-primary">
                            <div class="row pt-2 pb-3 bg-info">
                                <div class="col-6">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="BuscaGastoComprobante" id="RBuscaGasto" value="RGasto">
                                        <label class="form-check-label" for="RBuscaGasto">Gastos</label>
                                    </div>
                                </div>
                                <div class="col-6 ">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="BuscaGastoComprobante" id="RBuscaComprobante" value="RComprobante">
                                        ...
                                        <div class="row mt-2 justify-content-center">
                                            <div class="col-5">
                                                <input type="text" id="BuscaGastoDesde"
                                                    class="form-control datepicker text-center" onkeypress="return jsNoEscribir(event)" placeholder="Desde">
                                            </div>
                                            <div class="col-1"></div>
                                            <div class="col-5">
                                                <input type="text" id="BuscaGastoHasta"
                                                    class="form-control datepicker text-center" onkeypress="return jsNoEscribir(event)" placeholder="Hasta">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    ...
                                    <div class="col-8">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="CheckEstadoGasto" value="1" id="BuscaGastoEstadoA">
                                            <label class="custom-control-label" for="BuscaGastoEstadoA">Abierto</label>
                                        </div>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="CheckEstadoGasto" value="2" id="BuscaGastoEstadoC">
                            ...
                            <div id="divBuscadorComprobante" style="display: none; height: 385px;">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="CheckEstadoComprobante" id="BuscaComprobanteEstadoP" value="1">
                                            <label class="custom-control-label" for="BuscaComprobanteEstadoP">Pagado</label>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="CheckEstadoComprobante" id="BuscaComprobanteEstadoA" value="0">
                                            <label class="custom-control-label" for="BuscaComprobanteEstadoA">Adeudado</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                ...
                                <div class="row mt-1 justify-content-center">
                                    <div class="col-5">
                                        <input type="text" id="BuscaComprobanteImporte" class="form-control text-center" onkeypress="return jsSoloNumeros(event)"
                                            placeholder="Importe" />
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-5">
                                        <input type="text" id="BuscaComprobanteNroComprobante" class="form-control" onkeypress="return jsSoloNumerosSinPuntos(event)"
