<%@ Page Title="AAEMM. Tipos de Pago" Language="VB" MasterPageFile="~/Forms/MP.master" AutoEventWireup="false" CodeFile="Frm_ABM_TipoPago.aspx.vb" Inherits="Forms_Frm_ABM_TipoPago" %>

<asp:Content ID="Contenido" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script src='<%= ResolveClientUrl("~/Scripts/Forms/DIM/Frm_ABM_TipoPago.js?version20200424_7")%>'></script>
    <script>
