        ...
        <li class="linea">
            ...
            <div class="Porc40_L">
                <ul>
                    ...
                    <li class="Formulario">
                        <span class="SpanDatoFormulario">Porc. Empresa :</span>
                        <input id="TxtPorcEmpresa" class="DatoFormulario InputDatoFormularioPorc" type="text" placeholder="%" maxlength="5" onkeypress="return jsSoloNumeros(event);">
                    </li>
                    <li class="Formulario">
                        <span class="SpanDatoFormulario">Porc. Afiliado :</span>
                        <input id="TxtPorcAfiliado" class="DatoFormulario InputDatoFormularioPorc" type="text" placeholder="%" maxlength="5" onkeypress="return jsSoloNumeros(event);">
                    </li>
                    <li class="Formulario">
                        <span class="SpanDatoFormulario">Porc. No Afiliado :</span>
                        <input id="TxtPorcNoAfiliado" class="DatoFormulario InputDatoFormularioPorc" type="text" placeholder="%" maxlength="5" onkeypress="return jsSoloNumeros(event);">
                    </li>
                    <li class="Formulario">
                        <span class="SpanDatoFormulario">Porc. Otro :</span>
                        <input id="TxtPorcOtro" class="DatoFormulario InputDatoFormularioPorc" type="text" placeholder="%" maxlength="5" onkeypress="return jsSoloNumeros(event);">
                    </li>
                </ul>
            </div>
        </li>
