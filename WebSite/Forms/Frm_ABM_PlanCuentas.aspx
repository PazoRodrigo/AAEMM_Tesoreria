<%@ Page Title="AAEMM. Plan de Cuentas" Language="VB" MasterPageFile="~/Forms/MP.master" AutoEventWireup="false" CodeFile="Frm_ABM_PlanCuentas.aspx.vb" Inherits="Forms_Frm_ABM_PlanCuentas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script src='<%= ResolveClientUrl("~/Scripts/Forms/Frm_ABM_PlanCuentas.js")%>'></script>
