...
Public Class WsProveedor
    ...
    Public Function TraerTodos() As Transfer
        ...
        Try
            Dim result As New List(Of DTO.DTO_Proveedor)
            Entidad.Proveedor.Refresh()
            Dim lista As List(Of Entidad.Proveedor) = Entidad.Proveedor.TraerTodos()
            If Not lista Is Nothing Then
                For Each item As Entidad.Proveedor In lista
