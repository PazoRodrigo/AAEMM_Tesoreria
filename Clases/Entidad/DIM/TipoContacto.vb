...
Namespace Entidad
    Public Class TipoContacto
        ...
        Private Shared _Todos As List(Of TipoContacto)
        Public Shared Property Todos() As List(Of TipoContacto)
            Get
                If _Todos Is Nothing Then
                    _Todos = DAL_TipoContacto.TraerTodos
                End If
                Return _Todos
            End Get
            Set(ByVal value As List(Of TipoContacto))
                _Todos = value
            End Set
        End Property
...
#Region " Constructores "
        ...
        Sub New(ByVal id As Integer)
            Dim objImportar As TipoContacto = TraerUno(id)
            ' DBE
        ...
        End Sub
        Sub New(ByVal DtODesde As DTO.DTO_TipoContacto)
            ' DBE
...
#Region " Métodos Estáticos"
        ' Traer
        Public Shared Function TraerUno(ByVal Id As Integer) As TipoContacto
            Dim result As TipoContacto = Todos.Find(Function(x) x.IdEntidad = Id)
            If result Is Nothing Then
                Throw New Exception("No existen resultados para la búsqueda")
            End If
            Return result
        End Function
        Public Shared Function TraerTodos() As List(Of TipoContacto)
            Return Todos
        End Function
        'Public Shared Function TraerUno(ByVal Id As Integer) As TipoContacto
        '    Dim result As TipoContacto= DAL_TipoContacto.TraerUno(Id)
        '    If result Is Nothing Then
        '        Throw New Exception("No existen resultados para la búsqueda")
        '    End If
        '    Return result
        'End Function
        'Public Shared Function TraerTodos() As List(Of TipoContacto)
        '    Dim result As List(Of TipoContacto) = DAL_TipoContacto.TraerTodos()
        '    If result Is Nothing Then
        '        Throw New Exception("No existen resultados para la búsqueda")
        '    End If
        '    Return result
...
#Region " Métodos Públicos"
        ...
        Public Sub Alta()
            ValidarAlta()
            DAL_TipoContacto.Alta(Me)
        End Sub
        Public Sub Baja()
            ValidarBaja()
            DAL_TipoContacto.Baja(Me)
        End Sub
        Public Sub Modifica()
            ValidarModifica()
            DAL_TipoContacto.Modifica(Me)
        End Sub
        ' Otros
        Public Function ToDTO() As DTO.DTO_TipoContacto
            Dim result As New DTO.DTO_TipoContacto With {
                .IdEntidad = IdEntidad,
                .Nombre = Nombre,
...
#Region " Métodos Privados "
        ...
        Private Sub ValidarNoDuplicados()
            ...
            Dim result As TipoContacto = Todos.Find(Function(x) x.Nombre.ToUpper = Nombre And x.IdEntidad <> IdEntidad)
            If Not result Is Nothing Then
                Throw New Exception("El Nombre a ingresar ya existe")
            End If
        End Sub
#End Region
    End Class ' TipoContacto
End Namespace ' Entidad

Namespace DTO
    Public Class DTO_TipoContacto
...
#Region " Atributos / Propiedades"
        ...
        Public Property Observaciones() As String = ""
#End Region
    End Class ' DTO_TipoContacto
End Namespace ' DTO

Namespace DataAccessLibrary
    Public Class DAL_TipoContacto

#Region " Stored "
        Const storeAlta As String = "DIM.p_TipoContacto_Alta"
        Const storeBaja As String = "DIM.p_TipoContacto_Baja"
        Const storeModifica As String = "DIM.p_TipoContacto_Modifica"
        Const storeTraerUnoXId As String = "DIM.p_TipoContacto_TraerUnoXId"
        Const storeTraerTodos As String = "DIM.p_TipoContacto_TraerTodos"
#End Region
#Region " Métodos Públicos "
        ' ABM
        Public Shared Sub Alta(ByVal entidad As TipoContacto)
            ...
            End Using
        End Sub
        Public Shared Sub Baja(ByVal entidad As TipoContacto)
        ...
        End Sub
        Public Shared Sub Modifica(ByVal entidad As TipoContacto)
        ...
        Public Shared Function TraerUno(ByVal id As Integer) As TipoContacto
            ...
            Dim result As New TipoContacto
            Dim pa As New parametrosArray
            pa.add("@id", id)
            Using dt As DataTable = Connection.Connection.TraerDt(store, pa)
                If Not dt Is Nothing Then
        ...
        Public Shared Function TraerTodos() As List(Of TipoContacto)
            ...
            Dim pa As New parametrosArray
            Dim listaResult As New List(Of TipoContacto)
            Using dt As DataTable = Connection.Connection.TraerDt(store, pa)
...
#End Region
#Region " Métodos Privados "
        Private Shared Function LlenarEntidad(ByVal dr As DataRow) As TipoContacto
            Dim entidad As New TipoContacto
            ' DBE
