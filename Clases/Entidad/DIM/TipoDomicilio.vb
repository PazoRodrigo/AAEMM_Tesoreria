...
Namespace Entidad
    Public Class TipoDomicilio
        ...
        Private Shared _Todos As List(Of TipoDomicilio)
        Public Shared Property Todos() As List(Of TipoDomicilio)
            Get
                If _Todos Is Nothing Then
                    _Todos = DAL_TipoDomicilio.TraerTodos
                End If
                Return _Todos
            End Get
            Set(ByVal value As List(Of TipoDomicilio))
                _Todos = value
            End Set
        End Property
...
#Region " Constructores "
        ...
        Sub New(ByVal id As Integer)
            Dim objImportar As TipoDomicilio = TraerUno(id)
            ' DBE
        ...
        End Sub
        Sub New(ByVal DtODesde As DTO.DTO_TipoDomicilio)
            ' DBE
...
#Region " Métodos Estáticos"
        ' Traer
        Public Shared Function TraerUno(ByVal Id As Integer) As TipoDomicilio
            Dim result As TipoDomicilio = Todos.Find(Function(x) x.IdEntidad = Id)
            If result Is Nothing Then
                Throw New Exception("No existen resultados para la búsqueda")
            End If
            Return result
        End Function
        Public Shared Function TraerTodos() As List(Of TipoDomicilio)
            Return Todos
        End Function
        'Public Shared Function TraerUno(ByVal Id As Integer) As TipoDomicilio
        '    Dim result As TipoDomicilio= DAL_TipoDomicilio.TraerUno(Id)
        '    If result Is Nothing Then
        '        Throw New Exception("No existen resultados para la búsqueda")
        '    End If
        '    Return result
        'End Function
        'Public Shared Function TraerTodos() As List(Of TipoDomicilio)
        '    Dim result As List(Of TipoDomicilio) = DAL_TipoDomicilio.TraerTodos()
        '    If result Is Nothing Then
        '        Throw New Exception("No existen resultados para la búsqueda")
        '    End If
        '    Return result
...
#Region " Métodos Públicos"
        ...
        Public Sub Alta()
            ValidarAlta()
            DAL_TipoDomicilio.Alta(Me)
        End Sub
        Public Sub Baja()
            ValidarBaja()
            DAL_TipoDomicilio.Baja(Me)
        End Sub
        Public Sub Modifica()
            ValidarModifica()
            DAL_TipoDomicilio.Modifica(Me)
        End Sub
        ' Otros
        Public Function ToDTO() As DTO.DTO_TipoDomicilio
            Dim result As New DTO.DTO_TipoDomicilio With {
                .IdEntidad = IdEntidad,
                .Nombre = Nombre,
...
#Region " Métodos Privados "
        ...
        Private Sub ValidarNoDuplicados()
            ...
            Dim result As TipoDomicilio = Todos.Find(Function(x) x.Nombre.ToUpper = Nombre And x.IdEntidad <> IdEntidad)
            If Not result Is Nothing Then
                Throw New Exception("El Nombre a ingresar ya existe")
            End If
        End Sub
#End Region
    End Class ' TipoDomicilio
End Namespace ' Entidad

Namespace DTO
    Public Class DTO_TipoDomicilio
...
#Region " Atributos / Propiedades"
        ...
        Public Property Observaciones() As String = ""
#End Region
    End Class ' DTO_TipoDomicilio
End Namespace ' DTO

Namespace DataAccessLibrary
    Public Class DAL_TipoDomicilio

#Region " Stored "
        Const storeAlta As String = "DIM.p_TipoDomicilio_Alta"
        Const storeBaja As String = "DIM.p_TipoDomicilio_Baja"
        Const storeModifica As String = "DIM.p_TipoDomicilio_Modifica"
        Const storeTraerUnoXId As String = "DIM.p_TipoDomicilio_TraerUnoXId"
        Const storeTraerTodos As String = "DIM.p_TipoDomicilio_TraerTodos"
#End Region
#Region " Métodos Públicos "
        ' ABM
        Public Shared Sub Alta(ByVal entidad As TipoDomicilio)
            ...
            End Using
        End Sub
        Public Shared Sub Baja(ByVal entidad As TipoDomicilio)
        ...
        End Sub
        Public Shared Sub Modifica(ByVal entidad As TipoDomicilio)
        ...
        Public Shared Function TraerUno(ByVal id As Integer) As TipoDomicilio
            ...
            Dim result As New TipoDomicilio
            Dim pa As New parametrosArray
            pa.add("@id", id)
            Using dt As DataTable = Connection.Connection.TraerDt(store, pa)
                If Not dt Is Nothing Then
        ...
        Public Shared Function TraerTodos() As List(Of TipoDomicilio)
            ...
            Dim pa As New parametrosArray
            Dim listaResult As New List(Of TipoDomicilio)
            Using dt As DataTable = Connection.Connection.TraerDt(store, pa)
...
#End Region
#Region " Métodos Privados "
        Private Shared Function LlenarEntidad(ByVal dr As DataRow) As TipoDomicilio
            Dim entidad As New TipoDomicilio
            ' DBE
