...
#Region " Stored "
        Const storeTraerUnoXId As String = "DIM.p_Provincia_TraerUnoXId"
        Const storeTraerTodos As String = "DIM.p_Provincia_TraerTodos"
#End Region
#Region " Métodos Públicos "
        ' Traer
        Public Shared Function TraerUno(ByVal id As Integer) As Provincia
        ...
        Private Shared Function LlenarEntidad(ByVal dr As DataRow) As Provincia
            ...
            If dr.Table.Columns.Contains("Provincia") Then
                If dr.Item("Provincia") IsNot DBNull.Value Then
                    entidad.Descripcion = dr.Item("Provincia").ToString.ToUpper.Trim
                End If
            End If
            If dr.Table.Columns.Contains("Letra") Then
                If dr.Item("Letra") IsNot DBNull.Value Then
                    entidad.Letra = dr.Item("Letra").ToString.ToUpper.Trim
                End If
            End If
            Return entidad
        End Function
